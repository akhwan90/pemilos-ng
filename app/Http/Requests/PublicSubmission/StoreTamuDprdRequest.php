...
class StoreTamuDprdRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'nama_alkap' => ['required', 'string', 'max:255'],
        ...
        // Jika metode PUT (Update), file wajib dihilangkan dan after_or_equal boleh diabaikan (kunjungan lawas)
    ...
    public function messages(): array
    {
        return [
            ...
            'nama_alkap.required' => 'Alat Kelengkapan Dewan (Alkap) wajib dipilih.',
            ...
            '*.mimes' => 'Format file tidak sesuai ketentuan.',
