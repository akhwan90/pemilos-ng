<template>
    <div class="space-y-6">
        ...
        >
            <div>
                <h2 class="text-xl font-bold text-gray-800">
                    Data Sekolah & Progres Pemilihan
                </h2>
                <p class="text-sm text-gray-500">
                    Monitoring progres pemilihan di setiap sekolah yang
                    terdaftar.
                </p>
            </div>
            ...
            >
                ...
                <div>
                    <input
                        ...
                        type="search"
                        placeholder="Cari nama, NPSN, dll..."
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-4 py-3">
                                <div class="flex gap-1 relative">
                                    <BaseButton
                                        ...
                                        @click="openModal('edit', item.npsn)"
                                        variant="warning"
                                        class="px-2 py-1 !min-h-0 text-xs"
                                        title="Edit"
                                    >
                                        Edit
                                    </BaseButton>
                                    ...
                                    >
                                        <template #trigger>
                                            <BaseButton
                                                variant="primary"
                                                class="px-2 py-1 !min-h-0 cursor-pointer text-xs flex items-center gap-1"
                                            >
                                                Opsi
                                                <svg
                                                    class="w-3 h-3"
                                        ...
                                        <router-link
                                            :to="
                                                '/admin/monitoring/hasil-vote/' +
                                                item.npsn
                                            "
                                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-medium text-emerald-600"
                                            >Monitoring Hasil Vote</router-link
                                        >
                                    </BaseDropdown>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3 text-center">
                                <span
                                    :class="{
                                        'bg-yellow-200 text-yellow-800 px-2 py-0.5 rounded font-bold':
                                            item.is_over_capacity,
                                    }"
                                >
                                    {{ item.jml_dpt }} ({{
                                        item.persentase_dpt
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-between text-xs mb-1">
                                    <span class="font-medium text-gray-700"
                                        >{{ item.jml_memilih }} Suara
                                        Masuk</span
                                    >
                                    <span class="font-bold text-emerald-600"
                                        >{{ item.persentase_memilih }}%</span
                                    >
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    <div
                                        class="bg-emerald-500 h-2.5"
                                        :style="
                                            'width: ' +
                                            item.persentase_memilih +
                                            '%'
                                        "
                                    ></div>
                                </div>
            ...
            >
                ...
                <div class="flex gap-2">
                    <button
                        ...
                        class="px-3 py-1 border border-gray-300 rounded bg-white text-sm disabled:opacity-50 hover:bg-gray-50"
                    >
                        Sebelumnya
                    </button>
                    <button
        ...
        <ModalEditSekolah
            ...
            @updated="fetchData(pagination.current_page)"
        />
