<template>
    <div class="space-y-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Lihat data seluruh user aplikasi Pemilos
                </p>
            </div>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-200 text-sm">
                        ...
                        >
                            ...
                            >
                                <BaseButton @click="openModal('user', item)" variant="primary" class="!py-1 !px-3 text-xs w-20">Edit</BaseButton>
                                <BaseButton @click="deleteUser(item.id)" variant="danger" class="!py-1 !px-3 text-xs w-20">Hapus</BaseButton>
                            </td>
        ...
        <ModalUser v-model="modals.user" :user="selectedUser" />
    </div>
</template>
...
import ModalUser from "./sekolah_modals/ModalUserSekolah.vue";
...
const deleteSiswa = async (item) => {
    if (
        confirm(
            `Apakah Anda yakin ingin menghapus data siswa "${item.nm_siswa}" secara permanen? Data yang telah dihapus tidak dapat dikembalikan.`,
        )
    ) {
        try {
