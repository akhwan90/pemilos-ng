				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div class="space-y-4">
						<div>
							...
							<input v-model="form.npsn" type="text" required :readonly="isEditMode" :class="['w-full px-3 py-2 border rounded-lg text-sm focus:ring-indigo-500', isEditMode ? 'bg-gray-100 cursor-not-allowed' : '']" />
						</div>
						<div>
