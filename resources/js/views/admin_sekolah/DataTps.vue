<template>
	<div class="space-y-6">
		...
		<ModalFormTps :show="showFormModal" :is-editing="isEditing" :tps-data="selectedTps" @close="showFormModal = false" @saved="fetchTps" />

		<ModalAdminTps :show="showAdminModal" :tps="selectedTps" @close="showAdminModal = false" />
	</div>
</template>
