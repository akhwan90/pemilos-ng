...
<head>
    ...
    <style>
        ...
        table.peserta th, table.peserta td {
            ...
            padding: 5px; /* Kurangi padding agar muat 1 halaman */
            text-align: left;
        }
        table.peserta th {
            text-align: center;
...
<body>
    <div id="page1">
        ...
        <p>
            <table class="no-border" style="width: 100%">
                ...
                <tr><td>Asal Organisasi/Komunitas</td><td>:</td><td>{{ $tamu->instansi }}</td></tr>
                <tr><td>Tanggal Audiensi</td><td>:</td><td>{{ $tamu->hari_berkunjung }}, {{ \Carbon\Carbon::parse($tamu->tanggal_berkunjung)->translatedFormat('d F Y') }}</td></tr>
                <tr><td>Jam</td><td>:</td><td>{{ $tamu->jam_berkunjung }} WIB</td></tr>
                <tr><td>Alkap/Penerima Audiensi</td><td>:</td><td>{{ $tamu->nama_alkap }}</td></tr>
                <tr><td>Jumlah Peserta</td><td>:</td><td>{{ $tamu->jumlah_peserta }} orang</td></tr>
                <tr><td>Maksud & Tujuan</td><td>:</td><td>{{ $tamu->tujuan_kunjungan }}</td></tr>
        ...
        <p>
            <div class="signature-box">
                Pengasih, {{ \Carbon\Carbon::parse($tamu->tanggal_berkunjung)->translatedFormat('d F Y') }}<br/>
    ...
    <div id="page2" class="page-break">
        ...
        <div class="title" style="text-align: center;">DAFTAR HADIR AUDIENSI</div>
        
        <table class="info">
            <tr><td width="40%">Hari Tanggal</td><td width="2%">:</td><td>{{ $tamu->hari_berkunjung }}, {{ \Carbon\Carbon::parse($tamu->tanggal_berkunjung)->translatedFormat('d F Y') }}</td></tr>
            <tr><td>Jam</td><td>:</td><td>{{ $tamu->jam_berkunjung }} WIB</td></tr>
            <tr><td>Tempat</td><td>:</td><td>Gedung DPRD Kabupaten Kulon Progo.</td></tr>
            <tr><td>Acara</td><td>:</td><td>Menerima Audiensi dari {{ $tamu->instansi }}</td></tr>
        </table>
